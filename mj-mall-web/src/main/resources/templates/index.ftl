...
<head>
	...
	<title>HK商城，优质！优质！</title>
	 <link rel="icon" href="assets/img/favicon.ico">

    <link rel="stylesheet" type="text/css" href="css/webbase.css" />
    <link rel="stylesheet" type="text/css" href="css/pages-HK-index.css" />
	...
	<div class="nav-top">
		<div class="top">
			<div class="py-container">
				<div class="shortcut">
					<ul class="fl">
						<li class="f-item">HK商城欢迎您！</li>
						<li class="f-item">请<a href="login.html" target="_blank">登录</a>　<span><a href="register.html" target="_blank">免费注册</a></span></li>
					</ul>
					<ul class="fr">
						<li class="f-item">我的订单</li>
						<li class="f-item space"></li>
						<li class="f-item"><a href="home.html" target="_blank">我的HK商城</a></li>
						<li class="f-item space"></li>
						<li class="f-item">HK商城会员</li>
						<li class="f-item space"></li>
						<li class="f-item">企业采购</li>
						<li class="f-item space"></li>
						<li class="f-item">关注HK商城</li>
						<li class="f-item space"></li>
			...
			<div class="py-container">
				<div class="yui3-g Logo">
					<div class="yui3-u Left logoArea">
						<a class="logo-bd" title="HK商城" href="index.html">
						...
						<div class="search">
							<form action="" class="sui-form form-inline">
								...
								<div class="input-append">
									...
									<button class="sui-btn btn-xlarge btn-danger" type="button" onclick="onSeach()">搜索</button>
								</div>
							</form>
						</div>
						<div class="hotwords">
							<ul>
								<li class="f-item">HK商城首发</li>
		...
		<div class="py-container">
			<div class="yui3-g SortList ">
				...
				<div class="yui3-u Right">
					<div class="news">
						<h4><em class="fl">HK商城快报</em><span class="fr tip">更多 ></span></h4>
				...
				<ul class="clearfix yui3-g Favourate picLB" id="picLBxxl">
					<li class="yui3-u-1-6">
						<dl class="picDl huozhe">
							<dd>
								<a href="" class="pic"><img src="https://img12.360buyimg.com/n3/jfs/t21415/332/642302956/189613/778f2021/5b13cd6cN8e12d4aa.jpg" alt="" /></a>
								<div class="like-text">
									<p>荣耀9i 4GB+64GB 幻夜黑 移动联通电信4G全面屏手机 </p>
									<h3>￥1199.00</h3>
								</div>
							</dd>
							<dd>
								<a href="" class="pic"><img src="https://img11.360buyimg.com/n3/jfs/t18010/178/1266475805/124462/64f61c52/5ac1f20cN7196beba.jpg" alt="" /></a>
								<div class="like-text">
									<p>荣耀畅玩7A 全面屏手机 全网通标配版 2GB+32GB 铂</p>
									<h3>￥699.00</h3>
								</div>
							</dd>
						</dl>
					...
					<li class="yui3-u-1-6">
						<dl class="picDl jilu">
							...
							<dd>
								<a href="" class="pic"><img src="https://img10.360buyimg.com/n3/jfs/t30070/76/521916146/410678/cbbe056c/5bf666ccNd895026a.jpg" alt="" /></a>
								<div class="like-text">
									<p>洁客(Drymax)低尘膨润土结团猫砂 10L</p>
									<h3>¥28.00</h3>
								</div>
							</dd>
						</dl>
					...
					<li class="yui3-u-1-6">
						<dl class="picDl tuhua">
							...
							<dd>
								<a href="" class="pic"><img src="https://img10.360buyimg.com/n3/jfs/t20662/10/1581435031/190993/a6d8969c/5b2cc7dbNfd592a57.jpg" alt="" /></a>
								<div class="like-text">
									<p>三星（G5500）</p>
									<p>移动联通双网通</p>
									<h3>¥566.00</h3>
					...
					<li class="yui3-u-1-6">
						<dl class="picDl huozhe">
							<dd>
								<a href="" class="pic"><img src="https://img14.360buyimg.com/n3/jfs/t2701/263/1732518191/248282/b1861893/5747b6bcN44f2ed59.jpg" alt="" /></a>
								<div class="like-text">
									<p>洁珊 宠物猫砂9L</p>
									<h3>¥116.00</h3>
								</div>
					...
					<li class="yui3-u-1-6">
						<dl class="picDl jilu">
							<dd>
								<a href="http://sc.chinaz.com/" class="pic"><img src="https://img13.360buyimg.com/n3/jfs/t18196/249/979760110/98991/8c16330c/5ab325cdNed3b1c44.jpg" alt="" /></a>
								<div class="like-text">
									<p>皇家(royal canin) 猫粮 幼猫猫粮K36-12月龄以下2kg</p>
									<h3>￥115.00</h3>
								</div>
							</dd>
							<dd>
								<a href="http://sc.chinaz.com/" class="pic"><img src="https://img14.360buyimg.com/n3/jfs/t21313/41/372642626/88598/cdc1c121/5b0b6af9N85fa4ae3.jpg" alt="" /></a>
								<div class="like-text">
									<p>飞利浦（PHILIPS）电吹风机 HP8200 家用大功率6档</p>
									<h3>￥149.00</h3>
								</div>
							</dd>
						</dl>
	...
	<div class="py-container">
		<div class="footlink">
			...
			<div class="Mod-copyright">
				...
				<p>地址：北京市昌平区幸福安路2号楼 邮编：100096 电话：400-118-4123 传真：010-81235343</p>
